...
{
    template <class Store> static ushiro::subscription_list bind(ushiro::event_bus& bus, Store& store)
    {
        return {};
    }
};
...
template <class Store> ushiro::subscription_list subscribe_event_list(ushiro::event_bus& bus, Store& store)
{
